...
ActorCritic::ActorCritic(
    ...
    : actor_critic(std::make_shared<ActorCriticModule>(state_space, action_space, hidden_size)),
      optimizer(std::make_shared<torch::optim::Adam>(actor_critic->parameters(), lr)), gamma(0.9f),
      first_entropy_factor(0.3), wanted_entropy_factor(0.01), entropy_factor_steps(1L << 12),
