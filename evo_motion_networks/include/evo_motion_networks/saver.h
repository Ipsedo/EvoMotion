...
template<typename T>
void save_torch(const std::string &output_folder_path, T to_save, const std::string &file_name) {
...
template<typename T>
void load_torch(const std::string &input_folder_path, T to_fill, const std::string &file_name) {
