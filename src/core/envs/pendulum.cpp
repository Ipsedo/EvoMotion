...
PendulumParams::PendulumParams()
		: pendule_mass(1.f), hinge_force(2e5f), hinge_max_speed(5.f), max_step(200) {}
...
std::vector<item> PendulumEnv::init_items() {
	...
	item base = create_item_box(glm::vec3(0.f, base_pos_y, base_pos_z), glm::mat4(1.f), glm::vec3(base_scale), 0.f);
