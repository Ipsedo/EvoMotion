...
public:
	 ...
	 * @return
	 */
    static btScalar getERP(btScalar timeStep, btScalar kSpring, btScalar kDamper) {
	 ...
	 */
    static btScalar
    getCFM(btScalar avoidSingularity, btScalar timeStep, btScalar kSpring, btScalar kDamper) {
