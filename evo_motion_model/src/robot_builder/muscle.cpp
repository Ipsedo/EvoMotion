...
BuilderMuscle::BuilderMuscle(
    const std::string &name, float attach_mass, const glm::vec3 &attach_scale, const Item &item_a,
    const glm::vec3 &pos_in_a, const Item &item_b, const glm::vec3 &pos_in_b, float force,
    float max_speed)
    : Muscle(
