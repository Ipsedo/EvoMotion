...
class CartPoleFactory final : public EnvironmentFactory {
public:
...
class CartPole3dFactory final : public EnvironmentFactory {
public:
...
class RobotWalkFactory final : public EnvironmentFactory {
public:
...
class RobotJumpFactory final : public EnvironmentFactory {
public:
