...
CartPole::CartPole(
    ...
    : Environment(num_threads, -9.8f), chariot_push_force(chariot_push_force),
      limit_angle(limit_angle), reset_frame_nb(reset_frame_nb), rng(seed), rd_uni(0.f, 1.f),
      step_idx(0), max_steps(max_steps), last_vel(0.f), last_ang_vel(0.f) {
